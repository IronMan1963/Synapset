package org.xtext.disim.cacher.generator;
...
public class RunEgxEngine {
	...
	private static final String INFILE_EXT = ".pc";
...
//			System.out.println("Engine file: " + engine.getClass().getResource("/main.egx").toURI());
			...
			// In memory model
			InMemoryEmfModel model = new InMemoryEmfModel(MODEL_ALIAS, resource, CacherPackage.eINSTANCE);
